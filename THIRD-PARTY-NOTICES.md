...
- PySide6 and Shiboken6: GNU Lesser General Public License v3 with Qt special exception, or another
  license offered by The Qt Company. The application uses the unmodified Python packages dynamically.
- keyboard: MIT License.
- winsdk: MIT License.
- pycaw: MIT License.
- comtypes: MIT License.
- Python and the Windows APIs retain their respective licenses and terms.

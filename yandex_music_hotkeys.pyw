...
def _hotkeys():
    keyboard.add_hotkey("ctrl+shift+z",     lambda: handle("prev"),           suppress=True)
    keyboard.add_hotkey("ctrl+shift+x",     lambda: handle("next"),           suppress=True)
    keyboard.add_hotkey("ctrl+shift+c",     lambda: handle("play_pause"),     suppress=True)
    keyboard.add_hotkey("ctrl+shift+left",  lambda: handle("seek_left"),      suppress=True)
    keyboard.add_hotkey("ctrl+shift+right", lambda: handle("seek_right"),     suppress=True)
    keyboard.add_hotkey("ctrl+shift+up",    lambda: handle("vol_up"),         suppress=True)
    keyboard.add_hotkey("ctrl+shift+down",  lambda: handle("vol_down"),       suppress=True)
    keyboard.add_hotkey("ctrl+shift+m",     lambda: handle("vol_mute"),       suppress=True)
    keyboard.add_hotkey("ctrl+shift+o",     lambda: handle("toggle_overlay"), suppress=True)
    keyboard.add_hotkey("ctrl+shift+k",     lambda: handle("show_help"),      suppress=True)
    keyboard.add_hotkey("ctrl+shift+h",     lambda: handle("launch"),         suppress=True)
    keyboard.wait()
